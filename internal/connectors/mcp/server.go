...
func NewServer(sessionService app.SessionService, issuer IssuerProfileWriteProvider, customer CustomerProfileWriteProvider, agreement AgreementServiceProvider, timeEntry TimeEntryServiceProvider, guard IngressGuard, logger *slog.Logger) *Server {
	...
	toolNames := registerTools(mcpServer, sessionService, issuer, customer, agreement, timeEntry, guard, logger)
